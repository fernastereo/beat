                                ...
                                <ul class="nav navbar-nav">
                                  ...
                                  <li class="dropdown messages-menu">
                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                      ...
                                      <span class="label label-success">@include('messages.unread-count')</span>
                                    </a>
                                    <ul class="dropdown-menu">
                                      <li class="header">You have @include('messages.unread-count') messages</li>
                                      <li>
                                  ...
                                  <li class="dropdown messages-menu">
                                    ...
                                    <ul class="dropdown-menu">
                                      <li>
                                        <!-- inner menu: contains the actual data -->
                                        @include('messages.partials.contacts')
                                      </li>
                                  ...
                                  <li class="dropdown user user-menu">
                                    ...
                                    <ul class="dropdown-menu">
                                      ...
                                      <li class="user-footer">
                                        <div class="pull-left">
                                          <a href="/users/{{ Auth::user()->email }}" class="btn btn-default btn-flat"><i class="fa fa-fw fa-user"></i>Profile</a>
                                        </div>
